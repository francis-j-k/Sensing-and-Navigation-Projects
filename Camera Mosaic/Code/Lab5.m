...
buildingDir = 'D:\NEU\images\RSN_calib\LSC_new\selected';
...
radDistortion = [0.00900 -0.02413 0]; 
tanDistortion = [0.00049 -0.00126];

cameraParams = cameraParameters("K",k,"RadialDistortion",radDistortion, "TangentialDistortion", tanDistortion);
